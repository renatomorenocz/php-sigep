...
$postagemReversa->setTipo(PhpSigep\Model\TipoColeta::TIPO_AUTORIZACAO_POSTAGEM);
$postagemReversa->setNumeroColeta('176160645');


$params = new PhpSigep\Model\CancelaPostagemReversa();
$params->setAccessData($accessData);
$params->setPostagemReversa($postagemReversa);


var_dump($phpSigep->cancelaPostagemReversa($params));
